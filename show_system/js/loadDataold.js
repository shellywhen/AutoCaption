...
function CQQ(data, cat_color, cat_x, cat_y, position = 'vertical') {
 ...
 // scale set up
      ...
      if(this.position === 'horizontal') {
        ...
        if (window.CQQ_MODE==true||window.CQQ_MODE==false) {
            this.xScale = d3.scalePoint()
                            .domain(this.data['o0'])

...
class UniformSvgImageModel(BaseModel):
    def name(self):
        return 'UniformSvgImageModel'
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(dataset_mode='svgimage')
        parser.set_defaults(which_model_netG='uniformsvgimage')
    ...
    def initialize(self, opt):
        ...
        self.loss_names = ['G_Close', 'G_L1', 'D_real', 'D_fake']
        ...
        if self.isTrain:
            ...
            self.criterionL1 = torch.nn.L1Loss() # I change to L2 loss
            self.closeloss = torch.nn.MSELoss()

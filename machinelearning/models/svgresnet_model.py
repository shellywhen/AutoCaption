...
class SvgResnetModel(BaseModel):
    def name(self):
        return 'SvgResnetModel'
    ...
    def initialize(self, opt):
        ...
        input_nc = [3, 6, 3, 1, 1, 1, 15, 15]
        output_nc = [10, 10, 10, 10, 10, 10, 10, 10]
        self.netG = networks.define_G(input_nc, output_nc, opt.ngf,
                                      opt.which_model_netG, opt.norm, not opt.no_dropout, opt.init_type, opt.init_gain, self.gpu_ids, opt.svgresnet_output * 3)

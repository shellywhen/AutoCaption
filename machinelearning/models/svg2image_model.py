...
class Svg2ImageModel(BaseModel):
    def name(self):
        return 'Svg2ImageModel'
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(which_model_netG='svg2image')
    ...
    def initialize(self, opt):
        ...
        if self.isTrain:
            ...
            self.criterionL1 = torch.nn.MSELoss() # I change to L2 loss
